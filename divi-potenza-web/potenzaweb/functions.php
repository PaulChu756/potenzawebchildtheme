<?php 
/**
 * Bistro - Divi Child theme custom functions
 */
...
function candy_enqueue_assets() {
	...
	wp_enqueue_style( 'candy-animate', get_template_directory_uri() . '/css/animate.css', array(), '2016', 'all' );
	wp_enqueue_script( 'candy-theme-customizer', get_template_directory_uri() . '/js/theme-customizer.js', array(), '20162305', true );
...
function candy_customize_register($wp_customize) {
	...
	$wp_customize->add_control( 'et_divi[hide_footer_section]', array(
		'label'		=> esc_html__( 'Hide Footer Section', 'Divi' ),
	...
	$wp_customize->add_control( 'et_divi[center_footer_content]', array(
		'label'		=> esc_html__( 'Center Footer Content', 'Divi' ),
	...
	$wp_customize->add_control( 'et_divi[footer_copyright_text]', array(
...
/*
	Divi Theme Settings Migration
	(based on "Gantry Export and Import Options" by Hassan Derakhshandeh)
	Remade for Divi - Divi > Theme Setting Migration (divi.space)
*/
